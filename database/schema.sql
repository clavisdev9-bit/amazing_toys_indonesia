...
-- Audit log for SOS → Odoo stock quantity synchronisation operations.
-- Written by backend/src/modules/stock-sync (StockSyncRepository).
-- =============================================================================
...
VALUES (
    gen_random_uuid(),
    'admin',
    '$2b$10$JORKpJfdn.Kkx0QWq/sVquMhDrh4MwQduu5Uv84/qyiBJihj2WOgy',
    'ADMIN',
